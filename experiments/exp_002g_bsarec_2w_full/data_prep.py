"""exp_002g_bsarec_2w_full / data_prep.py -- 2-week training INCLUDING val window.

Trains BSARec on the last 14 days = Feb 15-29, which includes the
Feb 27-29 spike. Mid-point between exp_002e (4w_full, more data) and
exp_002f (1w_full, spike-only).
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=int,
        default=14,
        help="keep only the last N days of the full train.parquet (Feb 15-29 by default).",
    )
    parser.add_argument("--out-dir", default=str(HERE / "data" / "cy_commerce_2w_full"))
    parser.add_argument("--dataset-name", default="cy_commerce_2w_full")
