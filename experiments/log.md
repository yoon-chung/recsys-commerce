...
| exp_004 | FEARec | sequential FFT+autocorr | — | — | — | FAILED — RecBole 1.2 hang at trainer.fit() init (CPU 99% 30+분 stuck) |
| exp_005 | BERT4Rec | sequential bidirectional MLM | TBD | TBD | — | RUNNING (Day 1B, replaces CL4SRec) |
| exp_006 | BSARec+CL4SRec hybrid | sequential FFT + contrastive | — | — | — | QUEUED (Day 1C, novel combination: BSARec backbone + CL4SRec InfoNCE aug — 팀원 aug 코드 차용) |
