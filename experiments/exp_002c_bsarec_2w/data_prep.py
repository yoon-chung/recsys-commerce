"""exp_002c_bsarec_2w / data_prep.py -- build 2-week RecBole atomic dataset.

Same as exp_002b_bsarec_4w/data_prep.py except `--last-days` defaults to 14
(last 2 weeks of train data, Feb 9-22 before fixed Feb 23-29 val), and output
goes to ./data/cy_commerce_2w/.

This file is gitignored via the global `**/data/` pattern.

Usage:
    python data_prep.py                       # default: last 14 days
"""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=int,
        default=14,
        help="keep only the last N days of train_df (2-week recency window). "
             "default 14 = Feb 9-22 (train side; val Feb 23-29 is fixed).",
    )
    parser.add_argument("--out-dir", default=str(HERE / "data" / "cy_commerce_2w"))
    parser.add_argument("--dataset-name", default="cy_commerce_2w")
